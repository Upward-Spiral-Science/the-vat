...
def main():
    with open('/Users/Tyler/synapsinR_7thA.tif.Pivots.txt.2011Features.txt?dl=0','r') as csvfile:
        ...
        np.save('/Users/Tyler/Google Drive/DataScience/synapse_features_log.npy',Xlog)
        np.save('/Users/Tyler/Google Drive/DataScience/synapse_features_sqrt.npy',Xsq)
        Xlog = log_transform(X, norm=True)
        Xsq = sqrt_transform(X, norm=True)
        np.save('/Users/Tyler/Google Drive/DataScience/synapse_features_log_normalized.npy',Xlog)
        np.save('/Users/Tyler/Google Drive/DataScience/synapse_features_sqrt_normalized.npy',Xsq)
